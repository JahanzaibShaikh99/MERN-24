      ...
      <form onSubmit={submitTeam} className="p-3">
        <div className="my-1">
          ...
          <input
            ...
            className="border-blue-200 border-[2px]"
            min={0}
          />
        </div>
        <div className="my-1">
        ...
        <thead>
          <tr>
            ...
            <th
              className=""
              onClick={() => {
                sortingType === SORT_TYPE.teamName.ASC
                  ? setSortingType(SORT_TYPE.teamName.DESC)
                  : setSortingType(SORT_TYPE.teamName.ASC);
              }}
            >
              name {sortingType === SORT_TYPE.teamName.ASC ? <Top /> : <Down />}
            </th>
            <th
              className="flex"
              onClick={() => {
                sortingType === SORT_TYPE.teamScore.ASC
                  ? setSortingType(SORT_TYPE.teamScore.DESC)
                  : setSortingType(SORT_TYPE.teamScore.ASC);
              }}
            >
              score{" "}
